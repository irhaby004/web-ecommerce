    ...
    <div class="row carousel-sliders">
        <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
            @foreach ($sliders as $slider)
                <div class="slide">
                    <img src="{{ asset('storage/images/' . $slider->image) }}" class="img-fluid z-depth-1" alt="1">
                    <span class="link">
                        <a href="{{ $slider->link }}" target="_blank">{{ $slider->link }}</a>
                    </span>
                    <span class="position z-depth-2">{{ $slider->position }}</span>
                    <a href="{{ lang_url('admin/delete/slider/' . $slider->id) }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="formAddSlide" action="" enctype="multipart/form-data">
                        ...
                        <div class="md-form">
                            ...
                            <div class="element-label-text">
                                <input type="text" value="" placeholder="http://yoursite.com/product-link-1"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary"
                        onclick="document.getElementById('formAddSlide').submit();">{{ __('admin_pages.add') }}</button>
                </div>
            </div>
        </div>
    </div>
