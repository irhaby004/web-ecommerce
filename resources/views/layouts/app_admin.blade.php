                ...
                <div class="row">
                    <div class="col-sm-3 col-md-3 col-lg-2 left-side">
                        ...
                        <ul class="nav">
                            ...
                            <li>
                                <a href="{{ lang_url('admin/apriori') }}" class="btn waves-effect waves-light">
                                ...
                                <form class="navbar-form navbar-right nav-bar-search"
                                    ...
                                    <div class="form-group is-empty waves-light waves-effect waves-light">
                                        <input class="form-control"
                                            placeholder="{{ __('admin_pages.search_product') }}"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            @foreach (Config::get('app.locales') as $locale)
                                                <li><a
                                                        href="{{ url(getSameUrlInOtherLang($locale)) }}">{{ $locale }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
